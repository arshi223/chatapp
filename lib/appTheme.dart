...
ThemeData lightThemeData(BuildContext context) {
  return ThemeData(
    ...
    visualDensity: VisualDensity.adaptivePlatformDensity, colorScheme: ColorScheme.light(primary: kPrimaryColor, secondary: kPrimaryColor).copyWith(secondary: kPrimaryColor),
  );
}
...
ThemeData darkThemeData(BuildContext context) {
  return ThemeData(
    ...
    textTheme: getTextTheme(),
    primaryTextTheme: getTextTheme(),
    visualDensity: VisualDensity.adaptivePlatformDensity, colorScheme: ColorScheme.dark().copyWith(secondary: kPrimaryColor),
  );
}
